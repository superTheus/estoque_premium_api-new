    ...
    try {
      ...
      foreach ($produtos as $key => $produto) {
        ...
        $produtosNota[] = [
          ...
          "mod_bc_icms" => $produto["mod_bc_icms"] ?? "0",
          "aliquota_icms" => $produto["aliquota_icms"] ?? 0,
          "cst_ipi" => $produto["cst_ipi"] ?? "50",
          "mod_bc_ipi" => $produto["mod_bc_ipi"] ?? "0",
          "enquadramento_legal_ipi" => $produto["enquadramento_legal_ipi"] ?? "999",
      ...
      $dadosEmissao = [
        ...
        "modoEmissao" => 1,
        "total" => $venda['total'] ?? 0,
        "troco" => $venda['total_troco'] ?? 0,
        "total_pago" => $venda['total_pago'] ?? 0,
        "total_frete" => $venda['total_frete'] ?? 0,
